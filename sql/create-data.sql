...
CREATE TABLE MS_Inventory (
    ...
    CONSTRAINT fk_inventory_product FOREIGN KEY (ProductID) REFERENCES MS_Products(ProductID),
    CONSTRAINT fk_inventory_administrator FOREIGN KEY (AdministratorID) REFERENCES MS_Administrators(AdministratorID)
);
...
CREATE TABLE MS_Orders (
    ...
    CONSTRAINT fk_orders_customer FOREIGN KEY (CustomerID) REFERENCES MS_Customers(CustomerID)
);
...
CREATE TABLE MS_OrderItems (
    ...
    CONSTRAINT fk_orderitems_order FOREIGN KEY (OrderID) REFERENCES MS_Orders(OrderID),
    CONSTRAINT fk_orderitems_product FOREIGN KEY (ProductID) REFERENCES MS_Products(ProductID)
);
...
CREATE TABLE MS_Payments (
    ...
    CustomerID NUMBER(10) NOT NULL,
    CONSTRAINT fk_payments_order FOREIGN KEY (OrderID) REFERENCES MS_Orders(OrderID),
    CONSTRAINT fk_payments_customer FOREIGN KEY (CustomerID) REFERENCES MS_Customers(CustomerID)
);
